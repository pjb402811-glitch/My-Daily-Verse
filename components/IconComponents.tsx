...
export const YouTubeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M10.806 15.694l4.87-2.694c.338-.188.338-.624 0-.812l-4.87-2.694c-.338-.188-.756.031-.756.406v5.388c0 .375.418.594.756.406zM23.125 7.562c-.313-1.156-1.25-2.094-2.406-2.406C18.75 4.75 12 4.75 12 4.75s-6.75 0-8.719.406c-1.156.313-2.094 1.25-2.406 2.406C.5 9.531.5 12 .5 12s0 2.469.375 4.438c.313 1.156 1.25 2.094 2.406 2.406C5.25 19.25 12 19.25 12 19.25s6.75 0 8.719-.406c1.156-.313 2.094 1.25 2.406-2.406C23.5 14.469 23.5 12 23.5 12s0-2.469-.375-4.438z" />
  </svg>
);
...
export const Cog6ToothIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.003 1.11-1.226.554-.223 1.19-.223 1.745 0 .55.223 1.02.684 1.11 1.226M9.594 3.94 8.25 15.006a3 3 0 1 1-2.093-2.093l.243-1.036c.27-.086.54-.15.81-.205l.23-.97a2.25 2.25 0 0 1 2.22-1.616c.365 0 .71.066.993.185l.23.97c.27.055.54.12.81.205l.244 1.036a3 3 0 1 1-2.093 2.093L9.594 3.94Zm4.81 0a1.5 1.5 0 0 0-1.82 0l-1.16 1.026a1.5 1.5 0 0 0 0 2.458l1.16 1.026a1.5 1.5 0 0 0 1.82 0l1.16-1.026a1.5 1.5 0 0 0 0-2.458l-1.16-1.026ZM12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z" />
    </svg>
);
